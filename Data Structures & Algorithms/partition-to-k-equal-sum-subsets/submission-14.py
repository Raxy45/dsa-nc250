class Solution:
    def canPartitionKSubsets(self, nums: List[int], k: int) -> bool:
        ...
        # When we have array like [100,10,5,5] then immediately 100 will error out
        # cause adding 100 at empty subset produces no result, therefore why to continue?
        # if it would have been [5,5,10,100] -> unnecessarily we would have done first 3 trees
        t = sum(nums)/k
        used = [False] * len(nums)
